...
argmax of any target function on any domain. We call the domain the space of
...
class SimulatedAnnealing(object):
    ...
    def __int__(self, temperature_of_time,
    ...
    def __call__(self, target_function):
        ...
        return metropolis_sampler(target_distribution)
